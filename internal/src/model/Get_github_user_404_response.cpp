...
Get_github_user_404_response::Get_github_user_404_response()
{
...
void Get_github_user_404_response::validate()
{
    // TODO: implement validation
}

web::json::value Get_github_user_404_response::toJson() const
{
...
bool Get_github_user_404_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_github_user_404_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_github_user_404_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Get_github_user_404_response::getCode() const
{
    return m_Code;
}


void Get_github_user_404_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Get_github_user_404_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void Get_github_user_404_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Get_github_user_404_response::getError() const
{
    return m_Error;
}


void Get_github_user_404_response::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Get_github_user_404_response::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Get_github_user_404_response::unsetError()
{
    m_ErrorIsSet = false;
}
