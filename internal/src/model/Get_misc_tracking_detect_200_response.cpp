...
Get_misc_tracking_detect_200_response::Get_misc_tracking_detect_200_response()
{
...
void Get_misc_tracking_detect_200_response::validate()
{
    // TODO: implement validation
}

web::json::value Get_misc_tracking_detect_200_response::toJson() const
{
...
bool Get_misc_tracking_detect_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("alternatives"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Get_misc_tracking_detect_200_response_alternatives_inner>> refVal_setAlternatives;
...
void Get_misc_tracking_detect_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_misc_tracking_detect_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Get_misc_tracking_detect_200_response::getTrackingNumber() const
{
    return m_Tracking_number;
}


void Get_misc_tracking_detect_200_response::setTrackingNumber(const utility::string_t& value)
{
    m_Tracking_number = value;
    m_Tracking_numberIsSet = true;
}

bool Get_misc_tracking_detect_200_response::trackingNumberIsSet() const
{
    return m_Tracking_numberIsSet;
}

void Get_misc_tracking_detect_200_response::unsetTracking_number()
{
    m_Tracking_numberIsSet = false;
}
utility::string_t Get_misc_tracking_detect_200_response::getCarrierCode() const
{
    return m_Carrier_code;
}


void Get_misc_tracking_detect_200_response::setCarrierCode(const utility::string_t& value)
{
    m_Carrier_code = value;
    m_Carrier_codeIsSet = true;
}

bool Get_misc_tracking_detect_200_response::carrierCodeIsSet() const
{
    return m_Carrier_codeIsSet;
}

void Get_misc_tracking_detect_200_response::unsetCarrier_code()
{
    m_Carrier_codeIsSet = false;
}
utility::string_t Get_misc_tracking_detect_200_response::getCarrierName() const
{
    return m_Carrier_name;
}


void Get_misc_tracking_detect_200_response::setCarrierName(const utility::string_t& value)
{
    m_Carrier_name = value;
    m_Carrier_nameIsSet = true;
}

bool Get_misc_tracking_detect_200_response::carrierNameIsSet() const
{
    return m_Carrier_nameIsSet;
}

void Get_misc_tracking_detect_200_response::unsetCarrier_name()
{
    m_Carrier_nameIsSet = false;
}
std::vector<std::shared_ptr<Get_misc_tracking_detect_200_response_alternatives_inner>> Get_misc_tracking_detect_200_response::getAlternatives() const
{
    return m_Alternatives;
}


void Get_misc_tracking_detect_200_response::setAlternatives(const std::vector<std::shared_ptr<Get_misc_tracking_detect_200_response_alternatives_inner>>& value)
{
    m_Alternatives = value;
    m_AlternativesIsSet = true;
}

bool Get_misc_tracking_detect_200_response::alternativesIsSet() const
{
    return m_AlternativesIsSet;
}

void Get_misc_tracking_detect_200_response::unsetAlternatives()
{
    m_AlternativesIsSet = false;
}
