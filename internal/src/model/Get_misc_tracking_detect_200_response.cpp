...
bool Get_misc_tracking_detect_200_response::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Get_misc_tracking_detect_200_response_data> refVal_setData;
...
utility::string_t Get_misc_tracking_detect_200_response::getCode() const
{
    return m_Code;
}


void Get_misc_tracking_detect_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Get_misc_tracking_detect_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void Get_misc_tracking_detect_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Get_misc_tracking_detect_200_response::getMessage() const
{
    return m_Message;
}


void Get_misc_tracking_detect_200_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Get_misc_tracking_detect_200_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void Get_misc_tracking_detect_200_response::unsetMessage()
{
    m_MessageIsSet = false;
}
std::shared_ptr<Get_misc_tracking_detect_200_response_data> Get_misc_tracking_detect_200_response::getData() const
{
    return m_Data;
}


void Get_misc_tracking_detect_200_response::setData(const std::shared_ptr<Get_misc_tracking_detect_200_response_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Get_misc_tracking_detect_200_response::dataIsSet() const
{
    return m_DataIsSet;
}

void Get_misc_tracking_detect_200_response::unsetData()
{
    m_DataIsSet = false;
}
