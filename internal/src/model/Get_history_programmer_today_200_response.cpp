...
void Get_history_programmer_today_200_response::validate()
{
...
bool Get_history_programmer_today_200_response::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("events"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Get_history_programmer_today_200_response_events_inner>> refVal_setEvents;
...
void Get_history_programmer_today_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_history_programmer_today_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
void Get_history_programmer_today_200_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Get_history_programmer_today_200_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void Get_history_programmer_today_200_response::unsetMessage()
{
    m_MessageIsSet = false;
}
utility::string_t Get_history_programmer_today_200_response::getDate() const
{
    return m_date;
}


void Get_history_programmer_today_200_response::setDate(const utility::string_t& value)
{
    m_date = value;
    m_dateIsSet = true;
}

bool Get_history_programmer_today_200_response::dateIsSet() const
{
    return m_dateIsSet;
}

void Get_history_programmer_today_200_response::unsetdate()
{
    m_dateIsSet = false;
}
std::vector<std::shared_ptr<Get_history_programmer_today_200_response_events_inner>> Get_history_programmer_today_200_response::getEvents() const
{
    return m_Events;
}


void Get_history_programmer_today_200_response::setEvents(const std::vector<std::shared_ptr<Get_history_programmer_today_200_response_events_inner>>& value)
{
    m_Events = value;
    m_EventsIsSet = true;
}

bool Get_history_programmer_today_200_response::eventsIsSet() const
{
    return m_EventsIsSet;
}

void Get_history_programmer_today_200_response::unsetEvents()
{
    m_EventsIsSet = false;
}
