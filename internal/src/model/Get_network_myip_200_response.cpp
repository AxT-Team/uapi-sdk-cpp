...
#include "CppRestOpenAPIClient/model/Get_network_myip_200_response.h"
...
void Get_network_myip_200_response::validate()
{
    // TODO: implement validation
}

web::json::value Get_network_myip_200_response::toJson() const
{
...
bool Get_network_myip_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_network_myip_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_network_myip_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Get_network_myip_200_response::getIp() const
{
    return m_Ip;
}


void Get_network_myip_200_response::setIp(const utility::string_t& value)
{
    m_Ip = value;
    m_IpIsSet = true;
}

bool Get_network_myip_200_response::ipIsSet() const
{
    return m_IpIsSet;
}

void Get_network_myip_200_response::unsetIp()
{
    m_IpIsSet = false;
}
utility::string_t Get_network_myip_200_response::getRegion() const
{
    return m_Region;
}


void Get_network_myip_200_response::setRegion(const utility::string_t& value)
{
    m_Region = value;
    m_RegionIsSet = true;
}

bool Get_network_myip_200_response::regionIsSet() const
{
    return m_RegionIsSet;
}

void Get_network_myip_200_response::unsetRegion()
{
    m_RegionIsSet = false;
}
utility::string_t Get_network_myip_200_response::getIsp() const
{
    return m_Isp;
}


void Get_network_myip_200_response::setIsp(const utility::string_t& value)
{
    m_Isp = value;
    m_IspIsSet = true;
}

bool Get_network_myip_200_response::ispIsSet() const
{
    return m_IspIsSet;
}

void Get_network_myip_200_response::unsetIsp()
{
    m_IspIsSet = false;
}
utility::string_t Get_network_myip_200_response::getLlc() const
{
    return m_Llc;
}


void Get_network_myip_200_response::setLlc(const utility::string_t& value)
{
    m_Llc = value;
    m_LlcIsSet = true;
}

bool Get_network_myip_200_response::llcIsSet() const
{
    return m_LlcIsSet;
}

void Get_network_myip_200_response::unsetLlc()
{
    m_LlcIsSet = false;
}
utility::string_t Get_network_myip_200_response::getAsn() const
{
    return m_Asn;
}


void Get_network_myip_200_response::setAsn(const utility::string_t& value)
{
    m_Asn = value;
    m_AsnIsSet = true;
}

bool Get_network_myip_200_response::asnIsSet() const
{
    return m_AsnIsSet;
}

void Get_network_myip_200_response::unsetAsn()
{
    m_AsnIsSet = false;
}
double Get_network_myip_200_response::getLatitude() const
{
    return m_Latitude;
}

void Get_network_myip_200_response::setLatitude(double value)
{
    m_Latitude = value;
    m_LatitudeIsSet = true;
}

bool Get_network_myip_200_response::latitudeIsSet() const
{
    return m_LatitudeIsSet;
}

void Get_network_myip_200_response::unsetLatitude()
{
    m_LatitudeIsSet = false;
}
double Get_network_myip_200_response::getLongitude() const
{
    return m_Longitude;
}

void Get_network_myip_200_response::setLongitude(double value)
{
    m_Longitude = value;
    m_LongitudeIsSet = true;
}

bool Get_network_myip_200_response::longitudeIsSet() const
{
    return m_LongitudeIsSet;
}

void Get_network_myip_200_response::unsetLongitude()
{
    m_LongitudeIsSet = false;
}
utility::string_t Get_network_myip_200_response::getBeginip() const
{
    return m_Beginip;
}


void Get_network_myip_200_response::setBeginip(const utility::string_t& value)
{
    m_Beginip = value;
    m_BeginipIsSet = true;
}

bool Get_network_myip_200_response::beginipIsSet() const
{
    return m_BeginipIsSet;
}

void Get_network_myip_200_response::unsetBeginip()
{
    m_BeginipIsSet = false;
}
utility::string_t Get_network_myip_200_response::getEndip() const
{
    return m_Endip;
}


void Get_network_myip_200_response::setEndip(const utility::string_t& value)
{
    m_Endip = value;
    m_EndipIsSet = true;
}

bool Get_network_myip_200_response::endipIsSet() const
{
    return m_EndipIsSet;
}

void Get_network_myip_200_response::unsetEndip()
{
    m_EndipIsSet = false;
}
utility::string_t Get_network_myip_200_response::getDistrict() const
{
    return m_District;
}


void Get_network_myip_200_response::setDistrict(const utility::string_t& value)
{
    m_District = value;
    m_DistrictIsSet = true;
}

bool Get_network_myip_200_response::districtIsSet() const
{
