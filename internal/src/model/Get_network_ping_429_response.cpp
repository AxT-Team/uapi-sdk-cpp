...
Get_network_ping_429_response::Get_network_ping_429_response()
{
...
void Get_network_ping_429_response::validate()
{
    // TODO: implement validation
}

web::json::value Get_network_ping_429_response::toJson() const
{
...
bool Get_network_ping_429_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_network_ping_429_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_network_ping_429_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Get_network_ping_429_response::getCode() const
{
    return m_Code;
}


void Get_network_ping_429_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Get_network_ping_429_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void Get_network_ping_429_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Get_network_ping_429_response::getMessage() const
{
    return m_Message;
}


void Get_network_ping_429_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Get_network_ping_429_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void Get_network_ping_429_response::unsetMessage()
{
    m_MessageIsSet = false;
}
