...
Post_text_markdown_to_html_503_response::Post_text_markdown_to_html_503_response()
{
...
void Post_text_markdown_to_html_503_response::validate()
{
    // TODO: implement validation
}

web::json::value Post_text_markdown_to_html_503_response::toJson() const
{
...
bool Post_text_markdown_to_html_503_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Post_text_markdown_to_html_503_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Post_text_markdown_to_html_503_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Post_text_markdown_to_html_503_response::getCode() const
{
    return m_Code;
}


void Post_text_markdown_to_html_503_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Post_text_markdown_to_html_503_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void Post_text_markdown_to_html_503_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Post_text_markdown_to_html_503_response::getMessage() const
{
    return m_Message;
}


void Post_text_markdown_to_html_503_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Post_text_markdown_to_html_503_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void Post_text_markdown_to_html_503_response::unsetMessage()
{
    m_MessageIsSet = false;
}
