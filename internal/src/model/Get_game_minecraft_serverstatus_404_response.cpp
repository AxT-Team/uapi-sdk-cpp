...
Get_game_minecraft_serverstatus_404_response::Get_game_minecraft_serverstatus_404_response()
{
...
void Get_game_minecraft_serverstatus_404_response::validate()
{
    // TODO: implement validation
}

web::json::value Get_game_minecraft_serverstatus_404_response::toJson() const
{
...
bool Get_game_minecraft_serverstatus_404_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_game_minecraft_serverstatus_404_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_game_minecraft_serverstatus_404_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Get_game_minecraft_serverstatus_404_response::getCode() const
{
    return m_Code;
}


void Get_game_minecraft_serverstatus_404_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Get_game_minecraft_serverstatus_404_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void Get_game_minecraft_serverstatus_404_response::unsetCode()
{
    m_CodeIsSet = false;
}
std::shared_ptr<Object> Get_game_minecraft_serverstatus_404_response::getDetails() const
{
    return m_Details;
}


void Get_game_minecraft_serverstatus_404_response::setDetails(const std::shared_ptr<Object>& value)
{
    m_Details = value;
    m_DetailsIsSet = true;
}

bool Get_game_minecraft_serverstatus_404_response::detailsIsSet() const
{
    return m_DetailsIsSet;
}

void Get_game_minecraft_serverstatus_404_response::unsetDetails()
{
    m_DetailsIsSet = false;
}
utility::string_t Get_game_minecraft_serverstatus_404_response::getMessage() const
{
    return m_Message;
}


void Get_game_minecraft_serverstatus_404_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Get_game_minecraft_serverstatus_404_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void Get_game_minecraft_serverstatus_404_response::unsetMessage()
{
    m_MessageIsSet = false;
}
