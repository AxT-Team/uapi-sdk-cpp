...
Post_clipzy_store_400_response::Post_clipzy_store_400_response()
{
...
void Post_clipzy_store_400_response::validate()
{
    // TODO: implement validation
}

web::json::value Post_clipzy_store_400_response::toJson() const
{
...
bool Post_clipzy_store_400_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Post_clipzy_store_400_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Post_clipzy_store_400_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Post_clipzy_store_400_response::getError() const
{
    return m_Error;
}


void Post_clipzy_store_400_response::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Post_clipzy_store_400_response::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Post_clipzy_store_400_response::unsetError()
{
    m_ErrorIsSet = false;
}
utility::string_t Post_clipzy_store_400_response::getDetails() const
{
    return m_Details;
}


void Post_clipzy_store_400_response::setDetails(const utility::string_t& value)
{
    m_Details = value;
    m_DetailsIsSet = true;
}

bool Post_clipzy_store_400_response::detailsIsSet() const
{
    return m_DetailsIsSet;
}

void Post_clipzy_store_400_response::unsetDetails()
{
    m_DetailsIsSet = false;
}
