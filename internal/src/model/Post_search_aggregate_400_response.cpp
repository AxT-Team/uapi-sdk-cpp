...
Post_search_aggregate_400_response::Post_search_aggregate_400_response()
{
...
void Post_search_aggregate_400_response::validate()
{
    // TODO: implement validation
}

web::json::value Post_search_aggregate_400_response::toJson() const
{
...
bool Post_search_aggregate_400_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Post_search_aggregate_400_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Post_search_aggregate_400_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Post_search_aggregate_400_response::getCode() const
{
    return m_Code;
}


void Post_search_aggregate_400_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Post_search_aggregate_400_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void Post_search_aggregate_400_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Post_search_aggregate_400_response::getMessage() const
{
    return m_Message;
}


void Post_search_aggregate_400_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Post_search_aggregate_400_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void Post_search_aggregate_400_response::unsetMessage()
{
    m_MessageIsSet = false;
}
utility::datetime Post_search_aggregate_400_response::getTimestamp() const
{
    return m_Timestamp;
}


void Post_search_aggregate_400_response::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool Post_search_aggregate_400_response::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void Post_search_aggregate_400_response::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
