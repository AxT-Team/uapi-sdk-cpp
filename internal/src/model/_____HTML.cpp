...
void _____HTML::validate()
{
    // TODO: implement validation
}

web::json::value _____HTML::toJson() const
{
...
bool _____HTML::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void _____HTML::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool _____HTML::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t _____HTML::getCode() const
{
    return m_Code;
}


void _____HTML::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool _____HTML::codeIsSet() const
{
    return m_CodeIsSet;
}

void _____HTML::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t _____HTML::getMessage() const
{
    return m_Message;
}


void _____HTML::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool _____HTML::messageIsSet() const
{
    return m_MessageIsSet;
}

void _____HTML::unsetMessage()
{
    m_MessageIsSet = false;
}
