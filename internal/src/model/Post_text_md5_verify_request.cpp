...
void Post_text_md5_verify_request::validate()
{
    // TODO: implement validation
}

web::json::value Post_text_md5_verify_request::toJson() const
{
...
bool Post_text_md5_verify_request::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Post_text_md5_verify_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Post_text_md5_verify_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Post_text_md5_verify_request::getHash() const
{
    return m_Hash;
}


void Post_text_md5_verify_request::setHash(const utility::string_t& value)
{
    m_Hash = value;
    m_HashIsSet = true;
}

bool Post_text_md5_verify_request::hashIsSet() const
{
    return m_HashIsSet;
}

void Post_text_md5_verify_request::unsetHash()
{
    m_HashIsSet = false;
}
utility::string_t Post_text_md5_verify_request::getText() const
{
    return m_Text;
}


void Post_text_md5_verify_request::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool Post_text_md5_verify_request::textIsSet() const
{
    return m_TextIsSet;
}

void Post_text_md5_verify_request::unsetText()
{
    m_TextIsSet = false;
}
