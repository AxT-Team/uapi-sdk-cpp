...
#include "CppRestOpenAPIClient/model/Post_image_ocr_400_response_oneOf_1.h"
...
Post_image_ocr_400_response_oneOf_1::Post_image_ocr_400_response_oneOf_1()
{
...
void Post_image_ocr_400_response_oneOf_1::validate()
{
    // TODO: implement validation
}

web::json::value Post_image_ocr_400_response_oneOf_1::toJson() const
{
...
bool Post_image_ocr_400_response_oneOf_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Post_image_ocr_400_response_oneOf_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Post_image_ocr_400_response_oneOf_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Post_image_ocr_400_response_oneOf_1::getCode() const
{
    return m_Code;
}


void Post_image_ocr_400_response_oneOf_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Post_image_ocr_400_response_oneOf_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void Post_image_ocr_400_response_oneOf_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Post_image_ocr_400_response_oneOf_1::getMessage() const
{
    return m_Message;
}


void Post_image_ocr_400_response_oneOf_1::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Post_image_ocr_400_response_oneOf_1::messageIsSet() const
{
    return m_MessageIsSet;
}

void Post_image_ocr_400_response_oneOf_1::unsetMessage()
{
    m_MessageIsSet = false;
}
