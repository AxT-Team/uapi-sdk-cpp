...
Get_network_urlstatus_200_response_oneOf_1::Get_network_urlstatus_200_response_oneOf_1()
{
    m_Status = 0;
    m_StatusIsSet = false;
...
void Get_network_urlstatus_200_response_oneOf_1::validate()
{
    // TODO: implement validation
}

web::json::value Get_network_urlstatus_200_response_oneOf_1::toJson() const
{
...
bool Get_network_urlstatus_200_response_oneOf_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_network_urlstatus_200_response_oneOf_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_network_urlstatus_200_response_oneOf_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Get_network_urlstatus_200_response_oneOf_1::getStatus() const
{
    return m_Status;
}

void Get_network_urlstatus_200_response_oneOf_1::setStatus(int32_t value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool Get_network_urlstatus_200_response_oneOf_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void Get_network_urlstatus_200_response_oneOf_1::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t Get_network_urlstatus_200_response_oneOf_1::getUrl() const
{
    return m_Url;
}


void Get_network_urlstatus_200_response_oneOf_1::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool Get_network_urlstatus_200_response_oneOf_1::urlIsSet() const
{
    return m_UrlIsSet;
}

void Get_network_urlstatus_200_response_oneOf_1::unsetUrl()
{
    m_UrlIsSet = false;
}
