...
Get_status_usage_200_response_anyOf_endpoints_inner::Get_status_usage_200_response_anyOf_endpoints_inner()
{
...
void Get_status_usage_200_response_anyOf_endpoints_inner::validate()
{
    // TODO: implement validation
}

web::json::value Get_status_usage_200_response_anyOf_endpoints_inner::toJson() const
{
...
bool Get_status_usage_200_response_anyOf_endpoints_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_status_usage_200_response_anyOf_endpoints_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_status_usage_200_response_anyOf_endpoints_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Get_status_usage_200_response_anyOf_endpoints_inner::getPath() const
{
    return m_Path;
}


void Get_status_usage_200_response_anyOf_endpoints_inner::setPath(const utility::string_t& value)
{
    m_Path = value;
    m_PathIsSet = true;
}

bool Get_status_usage_200_response_anyOf_endpoints_inner::pathIsSet() const
{
    return m_PathIsSet;
}

void Get_status_usage_200_response_anyOf_endpoints_inner::unsetPath()
{
    m_PathIsSet = false;
}
int32_t Get_status_usage_200_response_anyOf_endpoints_inner::getCount() const
{
    return m_Count;
}

void Get_status_usage_200_response_anyOf_endpoints_inner::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool Get_status_usage_200_response_anyOf_endpoints_inner::countIsSet() const
{
    return m_CountIsSet;
}

void Get_status_usage_200_response_anyOf_endpoints_inner::unsetCount()
{
    m_CountIsSet = false;
}
