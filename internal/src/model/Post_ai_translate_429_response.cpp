...
Post_ai_translate_429_response::Post_ai_translate_429_response()
{
    m_Code = 0;
    m_CodeIsSet = false;
...
void Post_ai_translate_429_response::validate()
{
    // TODO: implement validation
}

web::json::value Post_ai_translate_429_response::toJson() const
{
...
bool Post_ai_translate_429_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Post_ai_translate_429_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Post_ai_translate_429_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t Post_ai_translate_429_response::getCode() const
{
    return m_Code;
}

void Post_ai_translate_429_response::setCode(int32_t value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Post_ai_translate_429_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void Post_ai_translate_429_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Post_ai_translate_429_response::getMessage() const
{
    return m_Message;
}


void Post_ai_translate_429_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Post_ai_translate_429_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void Post_ai_translate_429_response::unsetMessage()
{
    m_MessageIsSet = false;
}
utility::string_t Post_ai_translate_429_response::getError() const
{
    return m_Error;
}


void Post_ai_translate_429_response::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Post_ai_translate_429_response::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Post_ai_translate_429_response::unsetError()
{
    m_ErrorIsSet = false;
}
