...
#include "CppRestOpenAPIClient/model/Base64_____.h"
...
void Base64_____::validate()
{
    // TODO: implement validation
}

web::json::value Base64_____::toJson() const
{
...
bool Base64_____::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Base64_____::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Base64_____::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Base64_____::getCode() const
{
    return m_Code;
}


void Base64_____::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Base64_____::codeIsSet() const
{
    return m_CodeIsSet;
}

void Base64_____::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Base64_____::getMessage() const
{
    return m_Message;
}


void Base64_____::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Base64_____::messageIsSet() const
{
    return m_MessageIsSet;
}

void Base64_____::unsetMessage()
{
    m_MessageIsSet = false;
}
