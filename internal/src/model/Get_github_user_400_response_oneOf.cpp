...
#include "CppRestOpenAPIClient/model/Get_github_user_400_response_oneOf.h"
...
Get_github_user_400_response_oneOf::Get_github_user_400_response_oneOf()
{
...
void Get_github_user_400_response_oneOf::validate()
{
    // TODO: implement validation
}

web::json::value Get_github_user_400_response_oneOf::toJson() const
{
...
bool Get_github_user_400_response_oneOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_github_user_400_response_oneOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_github_user_400_response_oneOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Get_github_user_400_response_oneOf::getCode() const
{
    return m_Code;
}


void Get_github_user_400_response_oneOf::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Get_github_user_400_response_oneOf::codeIsSet() const
{
    return m_CodeIsSet;
}

void Get_github_user_400_response_oneOf::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Get_github_user_400_response_oneOf::getError() const
{
    return m_Error;
}


void Get_github_user_400_response_oneOf::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Get_github_user_400_response_oneOf::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Get_github_user_400_response_oneOf::unsetError()
{
    m_ErrorIsSet = false;
}
