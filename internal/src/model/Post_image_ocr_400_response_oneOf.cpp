...
#include "CppRestOpenAPIClient/model/Post_image_ocr_400_response_oneOf.h"
...
Post_image_ocr_400_response_oneOf::Post_image_ocr_400_response_oneOf()
{
...
void Post_image_ocr_400_response_oneOf::validate()
{
    // TODO: implement validation
}

web::json::value Post_image_ocr_400_response_oneOf::toJson() const
{
...
bool Post_image_ocr_400_response_oneOf::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Post_image_ocr_400_response_oneOf::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Post_image_ocr_400_response_oneOf::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Post_image_ocr_400_response_oneOf::getCode() const
{
    return m_Code;
}


void Post_image_ocr_400_response_oneOf::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool Post_image_ocr_400_response_oneOf::codeIsSet() const
{
    return m_CodeIsSet;
}

void Post_image_ocr_400_response_oneOf::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t Post_image_ocr_400_response_oneOf::getMessage() const
{
    return m_Message;
}


void Post_image_ocr_400_response_oneOf::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool Post_image_ocr_400_response_oneOf::messageIsSet() const
{
    return m_MessageIsSet;
}

void Post_image_ocr_400_response_oneOf::unsetMessage()
{
    m_MessageIsSet = false;
}
