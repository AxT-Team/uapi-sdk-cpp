...
Get_network_ping_200_response::Get_network_ping_200_response()
{
    m_Avg = 0.0;
    m_AvgIsSet = false;
    m_Code = 0;
...
void Get_network_ping_200_response::validate()
{
    // TODO: implement validation
}

web::json::value Get_network_ping_200_response::toJson() const
{
...
bool Get_network_ping_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_network_ping_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_network_ping_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
double Get_network_ping_200_response::getAvg() const
{
    return m_Avg;
}

void Get_network_ping_200_response::setAvg(double value)
{
    m_Avg = value;
    m_AvgIsSet = true;
}

bool Get_network_ping_200_response::avgIsSet() const
{
    return m_AvgIsSet;
}
...
void Get_network_ping_200_response::setHost(const utility::string_t& value)
{
    m_Host = value;
    m_HostIsSet = true;
}

bool Get_network_ping_200_response::hostIsSet() const
{
    return m_HostIsSet;
}

void Get_network_ping_200_response::unsetHost()
{
    m_HostIsSet = false;
}
utility::string_t Get_network_ping_200_response::getIp() const
{
    return m_Ip;
}


void Get_network_ping_200_response::setIp(const utility::string_t& value)
{
    m_Ip = value;
    m_IpIsSet = true;
}

bool Get_network_ping_200_response::ipIsSet() const
{
    return m_IpIsSet;
}

void Get_network_ping_200_response::unsetIp()
{
    m_IpIsSet = false;
}
utility::string_t Get_network_ping_200_response::getLocation() const
{
    return m_Location;
}


void Get_network_ping_200_response::setLocation(const utility::string_t& value)
{
    m_Location = value;
    m_LocationIsSet = true;
}

bool Get_network_ping_200_response::locationIsSet() const
{
    return m_LocationIsSet;
}

void Get_network_ping_200_response::unsetLocation()
{
    m_LocationIsSet = false;
}
double Get_network_ping_200_response::getMax() const
{
    return m_Max;
}

void Get_network_ping_200_response::setMax(double value)
{
    m_Max = value;
    m_MaxIsSet = true;
}

bool Get_network_ping_200_response::maxIsSet() const
{
    return m_MaxIsSet;
}

void Get_network_ping_200_response::unsetMax()
{
    m_MaxIsSet = false;
}
double Get_network_ping_200_response::getMin() const
{
    return m_Min;
}

void Get_network_ping_200_response::setMin(double value)
{
    m_Min = value;
    m_MinIsSet = true;
}

bool Get_network_ping_200_response::minIsSet() const
{
    return m_MinIsSet;
}

void Get_network_ping_200_response::unsetMin()
{
    m_MinIsSet = false;
}
